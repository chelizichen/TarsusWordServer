...
export class getUserPlanByIdRes{
    ...
    constructor(...args:any[]){
        ...
        this.user = _TarsusReadStream.read_struct(1,"User");this.data = _TarsusReadStream.read_list(2,"List<PlanWords>");
...
export class getPlanDetailByIdRes{
    ...
    constructor(...args:any[]){
        ...
        this.data = _TarsusReadStream.read_struct(1,"PlanDetail");this.code = _TarsusReadStream.read_int(2);
...
export class getPlanWordsByIdRes{
    ...
    constructor(...args:any[]){
        ...
        this.data = _TarsusReadStream.read_list(1,"List<PlanWords>");
        this.code = _TarsusReadStream.read_int(2);
        this.message = _TarsusReadStream.read_string(3);
        this.total = _TarsusReadStream.read_int(4);
    }
